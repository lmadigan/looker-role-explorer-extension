...
export interface ITransport {
    ...
    stream<T>(callback: (readable: Readable) => Promise<T>, method: HttpMethod, path: string, queryParams?: any, body?: any, authenticator?: Authenticator, options?: Partial<ITransportSettings>): Promise<T>;
}
 ...
 */
export declare function addQueryParams(path: string, obj?: {
    [key: string]: string;
}): string;
