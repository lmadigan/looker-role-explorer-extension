...
export interface IDialect {
     ...
     */
    supports_upload_tables?: boolean;
    /**
...
export interface IIntegration {
    ...
    /**
     * A list of data formats the integration supports. If unspecified, this will default to ["txt", "csv", "inline_json", "json", "json_detail", "json_detail_lite_stream", "xlsx", "html", "wysiwyg_pdf", "assembled_pdf", "wysiwyg_png", "csv_zip"]. Valid values are: "txt", "csv", "inline_json", "json", "json_detail", "json_detail_lite_stream", "xlsx", "html", "wysiwyg_pdf", "assembled_pdf", "wysiwyg_png", "csv_zip". (read-only)
     */
 ...
 */
export interface IWriteDataActionRequest {
    /**
     * The JSON describing the data action. This JSON should be considered opaque and should be passed through unmodified from the query result it came from.
     */
    action?: IDictionary<string>;
 ...
 */
export interface IWriteSqlQueryCreate {
    /**
     * Name of the db connection on which to run this query
     */
    connection_name?: string;
 ...
 */
export interface IWriteWriteScheduledPlan {
    /**
     * Name of this scheduled plan
     */
    name?: string;
