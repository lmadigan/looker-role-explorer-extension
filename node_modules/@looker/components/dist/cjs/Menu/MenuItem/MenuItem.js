...
var MenuItemDetail_1 = require("./MenuItemDetail");
var MenuItemListItem_1 = require("./MenuItemListItem");
var menuItemStyle_1 = require("./menuItemStyle");
...
exports.MenuItem = function (props) {
    ...
    var style = assignCustomizations(menuItemStyle_1.defaultMenuItemStyle, customizationProps);
    ...
    return (react_1.default.createElement(MenuItemListItem_1.MenuItemListItem, __assign({ current: current, itemStyle: style, "aria-current": current && 'page', onClick: onClick }, listItemProps, outerProps),
        react_1.default.createElement(MenuItemButton_1.MenuItemButton, __assign({ as: itemRole === 'link' ? 'a' : 'button', role: "menuitem", href: href, target: target }, clickTargetProps),
            icon && (react_1.default.createElement(Icon_1.Icon, { name: icon, mr: "xsmall", size: iconSize / compactIconModifier, color: iconColor })),
            children),
