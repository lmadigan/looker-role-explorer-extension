...
var ModalPortal_1 = require("../Modal/ModalPortal");
var OverlaySurface_1 = require("../Overlay/OverlaySurface");
var utils_1 = require("../utils");
function useVerticalSpace(ref, pin, placement, isOpen) {
    var _a = react_1.useState(0), verticalSpace = _a[0], setVerticalSpace = _a[1];
...
function useOpenWithoutElement(isOpen, ref) {
    var _a = react_1.useState(isOpen && ref.current === null), openWithoutElem = _a[0], setOpenWithoutElem = _a[1];
    react_1.useEffect(function () {
...
function usePopoverToggle(_a, portalRef, triggerRef) {
    ...
    var _c = react_1.useState(controlledIsOpen), uncontrolledIsOpen = _c[0], uncontrolledSetOpen = _c[1];
    var isControlled = utils_1.useControlWarn({
...
function usePopover(_a) {
    ...
    var focusRef = utils_1.useFocusTrap();
    ...
    var _g = react_1.useState(hoverDisclosureRef === undefined), isHovered = _g[0], setIsHovered = _g[1];
    ...
    var popover = !openWithoutElem && isOpen && (react_1.default.createElement(Modal_1.ModalContext.Provider, { value: { closeModal: handleClose } },
        react_1.default.createElement(ModalPortal_1.ModalPortal, { portalRef: portalRef },
            react_1.default.createElement(react_popper_1.Popper, { positionFixed: true, placement: propsPlacement, innerRef: focusRef, modifiers: {
                    flip: {
                        behavior: 'flip',
                        enabled: !pin,
                        flipVariations: true,
                ...
                return (react_1.default.createElement(OverlaySurface_1.OverlaySurface, { arrow: arrow, arrowProps: arrowProps, placement: placement, ref: ref, style: style, backgroundColor: "palette.white", border: "1px solid", borderColor: "palette.charcoal200", borderRadius: "medium", boxShadow: 3, color: "palette.charcoal900" }, verticalSpace > 50 ? (react_1.default.createElement(Layout_1.Box, { maxHeight: "calc(" + (verticalSpace - 10) + "px - 1rem)", overflowY: "scroll" }, content)) : (content)));
            }))));
    return {
